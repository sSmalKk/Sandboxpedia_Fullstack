...
beforeAll(async function (){
  try {
    ...
    insertedWorldData = await WorldData.insertOne({
      ...
      z: 495,
      l: 364,
      parentPattern: 'violet',
      pattern: '65ea0bf19586b704bf8b6798',
      sizeMax: '65ea0bf19586b704bf8b6799',
      size: 791,
      innerDiminnerDim: 'panel',
      id: '65ea0bf19586b704bf8b679a'
    });
    const user = dbInstance.collection('users');
    insertedUser = await user.insertOne({
      username: 'Pauline68',
      password: '5UaWFJJDKIcvvwF',
      email: 'Raymundo.Leannon10@yahoo.com',
      name: 'Tim Gaylord',
      userType: 814,
      righthand: 'deposit',
      lefthand: 'Tasty',
      equipedeitens: 'Valley',
      x: 136,
      y: 819,
      z: 347,
      location: '65ea0bf19586b704bf8b67a0',
      universe: 'Korean',
      apearances: [
        {
          _id: false,
      ...
      mobileNo: '(780) 165-3467',
      resetPasswordLink: {},
      loginRetryLimit: 483,
      loginReactiveTime: '2024-04-14T09:00:13.269Z',
      id: '65ea0bf19586b704bf8b67a1'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Frederic59',
        'password':'2GLhcM2eumVKEfY',
        'email':'Selina.Miller@yahoo.com',
        'name':'Mr. Freddie Schoen',
        'userType':authConstant.USER_TYPES.User,
        'righthand':'Paradigm',
        'lefthand':'EXE',
        'equipedeitens':'Licensed',
        'x':792,
        'y':718,
        'z':274,
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Selina.Miller@yahoo.com', });
